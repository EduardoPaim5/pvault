...
- Nenhum segredo é aceito por argumento, variável de ambiente ou arquivo
  temporário em texto claro.
...
## 7. Persistência, concorrência e recuperação
...
## 9. Três arquiteturas possíveis para Android
